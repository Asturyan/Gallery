...
class GalleryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gallery.Model.Map.GalleryTableMap';
     ...
     */
    const OM_CLASS = '\\Gallery\\Model\\Gallery';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gallery.Model.Gallery';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(GalleryTableMap::ID, GalleryTableMap::VISIBLE, GalleryTableMap::POSITION, GalleryTableMap::CREATED_AT, GalleryTableMap::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(GalleryTableMap::ID => 0, GalleryTableMap::VISIBLE => 1, GalleryTableMap::POSITION => 2, GalleryTableMap::CREATED_AT => 3, GalleryTableMap::UPDATED_AT => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gallery\\Model\\Gallery');
    ...
    {
        $this->addRelation('GalleryImage', '\\Gallery\\Model\\GalleryImage', RelationMap::ONE_TO_MANY, array('id' => 'gallery_id', ), 'CASCADE', 'RESTRICT', 'GalleryImages');
        $this->addRelation('GalleryI18n', '\\Gallery\\Model\\GalleryI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'GalleryI18ns');
    } // buildRelations()
    ...
    /**
     * Method to invalidate the instance pool of all tables related to gallery     * by a foreign key with ON DELETE CASCADE
     */
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(GalleryTableMap::ID);
            $criteria->addSelectColumn(GalleryTableMap::VISIBLE);
            $criteria->addSelectColumn(GalleryTableMap::POSITION);
            $criteria->addSelectColumn(GalleryTableMap::CREATED_AT);
            $criteria->addSelectColumn(GalleryTableMap::UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gallery\Model\Gallery) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(GalleryTableMap::DATABASE_NAME);
            $criteria->add(GalleryTableMap::ID, (array) $values, Criteria::IN);
        }

        $query = GalleryQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { GalleryTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { GalleryTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(GalleryTableMap::ID) && $criteria->keyContainsValue(GalleryTableMap::ID) ) {
